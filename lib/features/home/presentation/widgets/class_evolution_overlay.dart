...
class ClassEvolutionOverlay extends StatefulWidget {
  ...
  @override
  State<ClassEvolutionOverlay> createState() => _ClassEvolutionOverlayState();
}

class _ClassEvolutionOverlayState extends State<ClassEvolutionOverlay>
                    ...
                    child: Column(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: widget.palette.primary.withValues(alpha: 0.34),
                          ),
                      ...
                      FadeTransition(
                        ...
                        child: _ClassPlate(
                          ...
                          accent: widget.palette.primary.withValues(alpha: 0.72),
                      ...
                      Transform.scale(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: widget.palette.secondary.withValues(alpha: 0.46),
                            ),
                            gradient: RadialGradient(
                              colors: [
                        ...
                        if (widget.onDismiss != null) ...[
                          ...
                          FilledButton(
                            ...
                            style: FilledButton.styleFrom(
                              backgroundColor: widget.palette.primary.withValues(alpha: 0.14),
                              foregroundColor: Colors.white,
                              minimumSize: const Size(190, 54),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(18),
                                side: BorderSide(
                                  color: widget.palette.secondary.withValues(alpha: 0.34),
                                ),
                              ),
                            ),
                            child: Text(
